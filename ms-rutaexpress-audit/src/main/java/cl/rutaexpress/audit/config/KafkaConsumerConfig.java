...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, EventEnvelope> consumerFactory() {
        ...
        props.put(JsonDeserializer.TRUSTED_PACKAGES, "cl.rutaexpress.audit.dto");
        props.put(JsonDeserializer.VALUE_DEFAULT_TYPE, EventEnvelope.class.getName());
        props.put(JsonDeserializer.USE_TYPE_INFO_HEADERS, false);
        // Empezar a leer desde el principio si el grupo es nuevo (útil para ambiente local/dev)
    ...
    public ConcurrentKafkaListenerContainerFactory<String, EventEnvelope> kafkaListenerContainerFactory(
        ...
        // Tras 3 reintentos con backoff fijo de 2s, publica en <topico>.DLT (ver Caso 3, sección 9)
